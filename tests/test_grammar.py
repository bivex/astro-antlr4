...
def run_all():
    ...
    total += 1
    passed += test("Empty frontmatter", "---\n---\n")
    total += 1
    passed += test("Simple frontmatter", "---\ntitle: Hello\n---\n")
    total += 1
    passed += test(
    ...
    total += 1
    passed += test("Simple div", "---\n---\n<div>hello</div>")
    total += 1
    passed += test("Nested elements", "---\n---\n<div><p>text</p></div>")
    total += 1
    passed += test(
        "Deeply nested",
    ...
    total += 1
    passed += test("Void/self-closing tag", "---\n---\n<br />")
    total += 1
    passed += test("Self-closing img", '---\n---\n<img src="photo.jpg" />')
    total += 1
    passed += test(
    ...
    total += 1
    passed += test(
        "Expression attribute with object",
        '---\n---\n<div class:list={["base", { active: true }]}>text</div>',
    )
    total += 1
    passed += test("Spread attribute", "---\n---\n<div {...props}>text</div>")
    total += 1
    passed += test("Colon attribute name", '---\n---\n<div :class="foo">text</div>')

    # ── Astro Directives ─────────────────────────────────────
    print("\n== Astro Directives ==")

    total += 1
    passed += test("client:load directive", "---\n---\n<ReactComp client:load />")
    total += 1
    passed += test(
        "client:only directive with expression",
        '---\n---\n<ReactComp client:only="react" />',
    )
    total += 1
    passed += test("client:visible directive", "---\n---\n<HeavyComp client:visible />")
    total += 1
    passed += test("client:idle directive", "---\n---\n<MyWidget client:idle />")
    total += 1
    passed += test("set:html directive", "---\n---\n<div set:html={content} />")
    total += 1
    passed += test("set:text directive", "---\n---\n<span set:text={label} />")
    total += 1
    passed += test("is:raw directive", "---\n---\n<div is:raw>{rawContent}</div>")
    total += 1
    passed += test(
    ...
    total += 1
    passed += test("slot attribute", '---\n---\n<div slot="header">content</div>')

    # ── Components ───────────────────────────────────────────
    print("\n== Components ==")

    total += 1
    passed += test("Simple component", "---\n---\n<Layout>content</Layout>")
    total += 1
    passed += test("Self-closing component", "---\n---\n<Header />")
    total += 1
    passed += test("Component with props", '---\n---\n<Card title="Hello" count={5} />')
    total += 1
    passed += test(
        "Nested components",
    ...
    total += 1
    passed += test("Dotted component name", "---\n---\n<Ui.Card>content</Ui.Card>")
    total += 1
    passed += test("Component with spread", "---\n---\n<Button {...props} />")
    total += 1
    passed += test(
    ...
    total += 1
    passed += test("Fragment element", "---\n---\n<Fragment>content</Fragment>")
    total += 1
    passed += test("Fragment self-close", "---\n---\n<Fragment />")
    total += 1
    passed += test(
    ...
    total += 1
    passed += test(
        "Script with string containing angle brackets",
    ...
    total += 1
    passed += test("Script with attributes", '---\n---\n<script src="app.js"></script>')

    # ── Style blocks ─────────────────────────────────────────
    print("\n== Style Blocks ==")

    total += 1
    passed += test("Empty style", "---\n---\n<style></style>")
    total += 1
    passed += test(
        "Style with rules",
        "---\n---\n<style>\n  h1 { color: red; }\n  .container { margin: 0; }\n</style>",
    ...
    total += 1
    passed += test(
        "Style with selectors and pseudo",
    ...
    total += 1
    passed += test(
        "Expression with string literals", "---\n---\n<div>{`Hello ${name}`}</div>"
    )
    total += 1
    passed += test(
    ...
    total += 1
    passed += test("Multiple expressions", "---\n---\n<div>{a} and {b}</div>")

    # ── Comments ─────────────────────────────────────────────
    print("\n== Comments ==")

    total += 1
    passed += test("HTML comment", "---\n---\n<div><!-- comment -->text</div>")
    total += 1
    passed += test(
    ...
    total += 1
    passed += test("Text only, no elements", "---\n---\nHello world")
    total += 1
    passed += test(
...
""",
    ...
    total += 1
    passed += test(
        "Component with client directive and children",
        """---
---
...
""",
    ...
    total += 1
    passed += test("No frontmatter just HTML", "<div>hello</div>")
    total += 1
    passed += test("Empty after frontmatter", "---\n---\n")
    total += 1
    passed += test("Self-closing void element", "---\n---\n<input />")
    total += 1
    passed += test("Boolean attribute on component", "---\n---\n<Modal open />")
    total += 1
    passed += test(
        "Component with many props",
